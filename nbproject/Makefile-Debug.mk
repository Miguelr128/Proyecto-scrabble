...
${OBJECTDIR}/vectorficha.o: vectorficha.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vectorficha.o vectorficha.cpp

${OBJECTDIR}/vectorfichajugador.o: vectorfichajugador.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vectorfichajugador.o vectorfichajugador.cpp
